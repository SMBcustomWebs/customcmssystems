<?php
    ...
    define( 'K_DB_NAME', 'scratz16_comm_db' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'scratz16_admin' );
    // 6.
    // Database password
    define( 'K_DB_PASSWORD', 'p4C.*,lD&D{U' );
    // 7.
    ...
    define( 'K_EMAIL_TO', 'website@smbcustomwebs.com' );

    // 14.
    // Will be used as the sender of messages delivered by contact forms to the address above.
    define( 'K_EMAIL_FROM', 'user_request@smbcustomwebs.com' );
    ...
    define( 'K_RECAPTCHA_SITE_KEY', '6LfHtKEqAAAAAN2RBnfzU0hOHxNwlIor1z21kY7X' );
    define( 'K_RECAPTCHA_SECRET_KEY', '6LfHtKEqAAAAADke-HhLtp6OtUDwbr9zGQVFfAdu' );
