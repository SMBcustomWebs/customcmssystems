    ...
    <cms:template title="Services"  clonable='1' dynamic_folders='1' folder_masterpage='bmenu/service.php' icon='wrench' order='1300' >
        <cms:globals>
            ...
            <cms:pagebuilder name='hro_hmv_pb' label='Home View Page Header (Hero)' skip_custom_fields='1' order='5'>
                <cms:section label='Service Homepage Hero - Single' name='hro_hmv_pb_sct'  masterpage='blocks/frame/hero.php' mosaic='ccs_hro_msc' />
				<cms:section label='Service Homepage Hero - Carousel' name='hro_crs_hmv_pb_sct'  masterpage='blocks/frame/hero_swpr.php' mosaic='ccs_hro_swpr_msc' />
            </cms:pagebuilder>
