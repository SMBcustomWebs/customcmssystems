...
<cms:ignore>
    NEW CATEGORY. Folders on product.php are dynamic, so a submenu is a
...
<cms:set fh_masterpage = 'product.php' />
<cms:set fh_page       = 'add-product.php' />
    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                >
                    ...
                    <cms:if k_success>
						...
						<cms:if k_success>
							<cms:if edit_id>
								...
								<div class="alert alert-success fw-bold">Product saved successfully!</div>
							<cms:else />
								<!-- We just created a new product. Catch the ID and redirect to Edit Mode -->
								<cms:redirect url="<cms:link 'add-product.php' />?pid=<cms:show k_last_insert_id />&created=1" />
							</cms:if>
						</cms:if>
					</cms:if>
					...
					<cms:if "<cms:gpc 'created' method='get' />">
						<div class="alert alert-success fw-bold border-success">
							<i class="fas fa-check-circle me-2"></i> Product created successfully! You can now add Gallery Images and Specifications below the form.
						</div>
					</cms:if>
                    ...
                    <div class="form-zone">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text mb-2">The public-facing name of the product.</div>
                    ...
                    <div class="form-zone">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="form-text mb-2">Check this box to strictly enforce stock limits on this item.</div>
                            ...
                            <div class="col-md-6 mb-4" id="in_stock_wrapper" style="display: none;">
                                ...
                                <div class="form-text mb-2">Total number of physical items in stock (Numbers only).</div>
                        ...
                        <div class="mb-4 mt-2">
                            ...
                            <div class="form-text mb-2">Describe this product. (Plain text only to preserve template styling).</div>
                    ...
                    <div class="form-zone">
                        ...
                        <div class="mb-4 bg-light p-3 border rounded">
                            ...
                            <div class="form-text mb-3">
                                If the base price varies based on quantity, configure it here.<br>
                        ...
                        <div class="mb-4 bg-light p-3 border rounded">
                            <label class="form-label fw-bold text-primary">Variants (Colors, Sizes, Custom Text)</label>
                            <div class="form-text mb-3">
                                Add each variant on a separate line. Use standard syntax or add price differences:<br>
                                &bull; <strong>Dropdown:</strong> <code>Color[Red | Black=+3 | Green=-2]</code><br>
                                &bull; <strong>Radio Buttons:</strong> Append an asterisk: <code>Size[Large | Medium | Small]*</code><br>
                                &bull; <strong>Text Input:</strong> <code>Your Message[*TEXT*=5]</code>
                            </div>
                            <cms:input type="bound" name="pp_options" class="form-control font-monospace" style="height: 120px;" placeholder="Size[Large | Medium | Small]*" />
                        </div>
                        ...
                        <div class="row bg-light p-3 border rounded mx-0">
                            <div class="col-md-5 mb-3 mb-md-0">
                                ...
                                <div class="form-text mb-2">Select 'No' if this is not a physical product.</div>
                                <div class="mt-2"><cms:input type="bound" name="pp_requires_shipping" /></div>
                            </div>
                            <div class="col-md-7">
                                <label class="form-label fw-bold text-primary">Shipping Charge Scale</label>
                    ...
                    <div class="form-zone">
                        <div class="zone-header">
                            ...
                            <p>Control where this item appears in site navigation and lists.</p>
                        </div>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end mb-5">
                        <button type="submit" class="btn btn-success btn-lg px-5 shadow-sm fw-bold">
							<cms:if edit_id>Save Changes<cms:else />Save Product</cms:if>
						</button>
					</div>
                ...
                <cms:set fd_masterpage = 'product.php' />
                <cms:set fd_label      = 'Products' />
                        ...
                        <div class="form-zone border border-primary shadow-sm" style="border-width: 2px !important;">
                            ...
                            <div class="d-flex flex-column gap-3 mt-4">
                                <div class="p-3 bg-white border rounded d-flex justify-content-between align-items-center">
                                    <div>
                                        <strong class="d-block mb-1">Product Image Gallery</strong>
                                        <small class="text-muted">Upload additional images for the product gallery slider.</small>
                                    </div>
                                ...
                                <div class="p-3 bg-white border rounded d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <small class="text-muted">Create categorized accordion sections (e.g., Dimensions, Return Policy, Safety Labels).</small>
                                    </div>
