        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="mb-0"><cms:if edit_id>Edit Service<cms:else />Add New Service</cms:if></h2>

                    <cms:if edit_id>
                        <a href="<cms:link 'add-service.php' />" class="btn btn-outline-primary fw-bold shadow-sm">
